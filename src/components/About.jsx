    ...
    <section id="about" className="section-container">
      ...
      >
        ...
        <div style={{
          ...
          >
            <h3 style={{ fontSize: '2rem', marginBottom: '0.3rem', fontFamily: 'var(--font-display)' }}>
              Muhammad Okasha
            </h3>
            <p style={{ color: 'var(--accent-color)', fontWeight: 600, fontSize: '1.1rem', marginBottom: '1.5rem', letterSpacing: '1px' }}>
              Machine Learning Engineer &amp; Data Scientist
            </p>
            <p style={{ color: 'var(--text-secondary)', fontSize: '1.05rem', lineHeight: 1.9, maxWidth: '600px' }}>
            ...
            <p style={{ color: 'var(--text-secondary)', fontSize: '1.05rem', lineHeight: 1.9, maxWidth: '600px', marginTop: '1rem' }}>
        ...
        >
          <h3 style={{
            fontSize: '1.6rem', marginBottom: '2rem',
            fontFamily: 'var(--font-display)',
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(320px, 1fr))', gap: '1.5rem' }}>
            {education.map((edu, i) => (
              <motion.div
                ...
                style={{ display: 'flex', alignItems: 'flex-start', gap: '1.2rem' }}
              >
                <div style={{
                ...
                <div>
                  <h4 style={{ fontSize: '1.1rem', color: 'var(--text-primary)', marginBottom: '0.3rem', lineHeight: 1.3 }}>
                    {edu.degree}
                  </h4>
                  <p style={{ color: 'var(--accent-color)', fontWeight: 600, fontSize: '0.9rem', marginBottom: '0.5rem' }}>
                    {edu.school}
                  </p>
                  <span style={{
